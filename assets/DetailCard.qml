...
// 「更好的一天」详情卡片内容：天气 / 日历 / 黄历 / 课表 / 一言
Item {
    id: root

    property var backend: null

    readonly property color textColor: Theme.isDark() ? "#F2F2F7" : "#1B1B1F"
    readonly property color dimColor: Theme.isDark() ? "#B4B4BD" : "#5A5A66"
    readonly property color accentColor: Theme.isDark() ? "#5CDCFF" : "#4099b2"
        ...
        StackLayout {
                ...
                Column {
                    ...
                    Row {
                        ...
                        Column {
                            ...
                            Subtitle {
                                text: (backend && backend.locationName)
                                    ? (backend.locationName
                                       + (backend.nowWeather.feelsLike !== undefined && backend.nowWeather.feelsLike !== null
                                          ? " · 体感 " + backend.nowWeather.feelsLike + "°" : ""))
                                    : ""
                            }
                        }
                    }
            ...
            Flickable {
                ...
                Column {
                    ...
                    Subtitle { text: qsTr("宜") + "  " + (almanacColumn.al.yi || []).join("、") }
                    Subtitle { text: qsTr("忌") + "  " + (almanacColumn.al.ji || []).join("、") }
                    Subtitle {
                        ...
                        text: almanacColumn.al.nextJieQi
                            ? (qsTr("下一个节气") + "  " + almanacColumn.al.nextJieQi
                               + (almanacColumn.al.daysToNextJieQi !== null && almanacColumn.al.daysToNextJieQi !== undefined
                                  ? "（还有 " + almanacColumn.al.daysToNextJieQi + " 天）" : ""))
                            : ""
                    }
                }
            }

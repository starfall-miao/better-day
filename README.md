...
第一次用记得去 **设置 → 插件 → 更好的一天** 里填上你的城市（比如「北京」「上海」「广州」），天气就会乖乖出现啦。天气数据来自 Open-Meteo，**不用申请 API Key**，开箱即用～
...
- ☁️ 天气 —— [Open-Meteo](https://open-meteo.com)（免费、无需 Key）
